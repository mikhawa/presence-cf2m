...
class Planning 
{
    ...
    function __construct(int $sessID)
    {
        ...
        $debutSession = '2022-05-03';
        $finSession = '2023-09-29';
...
//        $this->afficheTableau("Liste des congés",$listeConges);
    ...
    public function extraireListeEntreDeuxDates(string $date1, string $date2) {
    ...
    public function convertirNumeroMoisVersNomMois(int $numero) {
    ...
    public function extraireCetteSemaine() {
    ...
    public function extraireSemaineProchaine() {
    ...
    public function extraireListeMois(int $mois,int $annee) {
    ...
    public function extraireCalendrier($mois, $annee) {
...
//            echo "La session va être prolongée à la fin, jusqu'au ".$dateFin->format("Y-m-d")."<br/>";
    ...
    private function calculJoursFeries(int $annee) {
        $listeFeries = array();
        $uneDate;
...
//        $this->afficheTableau("Liste des jours fériés", $listeFeries);
    ...
    private function calculExtraLegalCF2M(int $annee) {
...
//        $this->afficheTableau("Liste des congés extra-légaux", $extraLegalCF2M);
    ...
    private function calculConges(int $sessionID) {
        $conges = array();
        ...
        $result = $dbConn->select("SELECT ladate,letype FROM leconge WHERE lasession_idlasession=".$sessionID);
        
        foreach($result as $cle=>$valeur){
/*            $datedebut = $valeur['debut'];
            $datefin = $valeur['fin'];*/
            $datedebut = $valeur['ladate'];
